...
public class DoctorHomeFragment extends Fragment implements AppointmentAdapter.OnAppointmentClickListener {
                    ...
                    public void onResponse(Call<List<AppointmentResponse>> call, Response<List<AppointmentResponse>> response) {
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            if (appointmentList.isEmpty()) {
                                ...
                                // Pass true for limitToThree
                                appointmentAdapter = new AppointmentAdapter(appointmentList, getContext(), true, DoctorHomeFragment.this);
    ...
    public void onAppointmentClick(Appointment appointment) {
        // Toast.makeText(getContext(), "Opening details...", Toast.LENGTH_SHORT).show();
