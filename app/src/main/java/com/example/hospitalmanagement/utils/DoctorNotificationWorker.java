...
public class DoctorNotificationWorker extends Worker {

    public DoctorNotificationWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                if (!requests.isEmpty()) {
                    NotificationHelper.showNotification(
                            ...
                            "You have " + requests.size() + " pending appointment requests.",
                            2001
                    );
                }
            }
